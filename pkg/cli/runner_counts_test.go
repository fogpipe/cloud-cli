...
// A runner with pods pending reads differently from one with them all
...
// A control plane that sends only the sum still renders, and an empty runner
...
// The runner view and the project-status view read the same three numbers
